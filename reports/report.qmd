...
We tested whether Pell eligibility, gender, or generational status changed the strength of the paths from meritocratic beliefs, STEM identity, and growth mindset to GPA. Chi‑square difference tests indicated no significant differences for Pell eligibility, gender, or generational status, however, the Pell grouping had a p-value of `p = 0.109` which may warrant further testing with larger samples. Other subgroup patterns also emerged:
